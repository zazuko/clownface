...
class Clownface {
   ...
   * @param {null|string|string[]|Clownface|Clownface[]} [values] blank node identifiers (uses generated if undefined of null)
   * @returns {Clownface}
   */
  blankNode (values) {
   ...
   * @param {string|string[]|boolean|boolean[]|number|number[]|Literal|Literal[]|Clownface|Clownface[]} values blank node identifiers (uses generated if undefined of null)
   ...
   * @param {string|string[]|Term|Term[]|Clownface|Clownface[]} values URI(s) or RDF/JS NamedNode(s)
   * @returns {Clownface}
   */
  namedNode (values) {
   ...
   * @param {GraphPointerCallback} [callback] a callback called for each graph pointer to the subjects
   ...
   *
   * @param {Term|Term[]|Clownface|Clownface[]} predicates
   * @param {*} objects one or more values to use for subjects
   * @param {GraphPointerCallback} [callback] a callback called for each graph pointer to the objects
   * @returns {Clownface} current graph pointer
   */
